...
class GmailAPIBot:
    def __init__(self, last_name="", rank="", selected_items=None, recipient_email=""):
        ...
        # Always send both types to the same email
        self.send_admin_copy = True  # Always send admin copy
        self.send_user_copy = True   # Always send user copy
        ...
        self.email_templates = []  # Store multiple email templates
        ...
        if "signup" in items_str:
            ...
            # Add both admin and user templates
            ...
            self.email_templates.append({
                ...
                "is_admin": True  # Suggestions are typically admin notifications
            })
    ...
    def send_email(self):
        ...
        try:
            ...
            for template in self.email_templates:
                # Create message for each template
